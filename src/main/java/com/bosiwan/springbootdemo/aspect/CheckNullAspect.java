...
import com.bosiwan.springbootdemo.annotation.NotNull;
import com.bosiwan.springbootdemo.entity.Info;
...
public class CheckNullAspect {
    ...
    // 拦截带@CheckNull的方法
    @Pointcut("@annotation(com.bosiwan.springbootdemo.annotation.CheckNull)")
